...
/** REST API for user management All endpoints require JWT authentication */
@Slf4j
@RestController
...
public class UserController {
  ...
  /** Get current authenticated user profile Extracts username from JWT token */
  @GetMapping("/me")
  ...
  /**
   * Extract username from JWT principal Supports both JwtAuthenticationToken and standard
   * Authentication
   */
